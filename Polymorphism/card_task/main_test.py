...
def test(rank_1, suit_1, rank_2, suit_2, expected_eq, expected_gt):
    ...
    print("Expected:")
    print(f" * {expected_eq} for equality")
    print(f" * {expected_gt} for greater than")
    print(f" * {not (expected_eq or expected_gt)} for less than")
    ...
    print("Actual:")
    print(f" * {result_eq} for equality")
    if result_eq != expected_eq:
        print("Fail")
        return False
    print(f" * {result_gt} for greater than")
    if result_gt != expected_gt:
        print("Fail")
        return False
    print(f" * {result_lt} for less than")
